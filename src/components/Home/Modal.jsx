            ...
            <div className="flex items-center justify-center  h-screen  ">
                ...
                <div className='flex  items-center  overflow-hidden shadow-xl transform transition-all  relative justify-center bg-white rounded-lg' >
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div>
                            <img src={photo.urls.full} className=" max-h-[50vh] h-auto w-[45vw]" alt="img" />
                        </div>
                        ...
                        <div className='flex items-center justify-between p-4 flex-wrap'>
                            ...
                            <div className='flex items-center '>
                                ...
                                <div className='flex flex-col ml-4'>
                                    <h1 className='Montserrat text-[15px]'>{photo.user.social.instagram_username}{" "}{photo.user.last_name}</h1>
                                ...
                                <div className='flex items-center   ml-4'>
                                    ...
                                    <div className='ml-4 flex items-center' >
                                        ...
                                        <h1> <a href={"https://twitter.com/" + photo.user.social.instagram_username}>    <p className='Poppins text-[10px] text-[#A7A7A7]'>/ {photo.user.username}</p> </a></h1>
                                    </div>


                                    <div className='ml-4 flex items-center' >
                                        <AiOutlineInstagram size={20} className='mr-2' />
                                        <h1> <a href={"https://instagram.com/" + photo.user.social.instagram_username}>    <p className='Poppins text-[10px] text-[#A7A7A7]'>/ {photo.user.username}</p> </a></h1>
                                    </div>
                            ...
                            <div className='flex items-center '>
                                {
                                    photo?.tags?.map(tag => {
                                        ...
                                        return <p className='bg-[#e7e7e7] px-4 py-1 rounded-md cursor-pointer ml-2 '>
                                            {tag.title}
                                        </p>
                                    })
